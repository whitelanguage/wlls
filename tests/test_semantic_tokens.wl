...
func main() -> Int {
    ...
    if (!has_token(contextual_tokens, 0, 9, "parameter") ||
        !has_token(contextual_tokens, 0, 36, "parameter")) {
    ...
    if (!has_token(named_tokens, 0, 24, "property") || !has_token(named_tokens, 1, 43, "parameter")) {
    ...
    if (!has_token(prelude_tokens, 0, 21, "function") || !has_token(prelude_tokens, 0, 45, "class") || !has_token(prelude_tokens, 0, 52, "class") || !has_token(prelude_tokens, 1, 29, "enum") || !has_token(prelude_tokens, 1, 35, "enumMember")) {
