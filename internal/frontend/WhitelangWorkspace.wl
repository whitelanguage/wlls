...
class FrontendWorkspace {
    ...
    func __member_key(owner_type: String, name: String) -> String {
        return owner_type + "." + name;
    }

    func __member_owner(type_name: String) -> String {
    ...
    func __apply_type_steps(type_name: String, steps: String) -> String {
        let result: String = type_name;
        let start: Int = 0;
        let i: Int = 0;
    ...
    func __imported_type(source: WorkspaceSource, type_name: String) -> SymbolDefinition {
        let block: BlockNode = source.result.syntax.ast;
        let i: Int = 0;
        let count: Int = 0;
    ...
    func resolve_member(path: String, owner_type: String, name: String) -> SymbolDefinition {
    ...
    func update(path: String, version: Int, text: String) -> FrontendResult {
    ...
    func find(path: String) -> WorkspaceSource {
        return self.documents[normalize_source_path(path)];
    }

    func __load_source(path: String) -> WorkspaceSource {
        let normalized: String = normalize_source_path(path);
    ...
    func __import_source(from_path: String, raw_path: String) -> WorkspaceSource {
    ...
    func __qualified_import(source_document: WorkspaceSource, qualifier: String, name: String) -> SymbolDefinition {
    ...
    func __star_import(source_document: WorkspaceSource, name: String) -> SymbolDefinition {
        let block: BlockNode = source_document.result.syntax.ast;
        let i: Int = 0;
        let count: Int = 0;
        if (block is !null && block.stmts is !null) { count = block.stmts.length(); }
    ...
    func __prelude(source_document: WorkspaceSource, name: String) -> SymbolDefinition {
    ...
    func definition(path: String, line: Int, utf16_column: Int) -> SymbolDefinition {
    ...
    func resolve_import(path: String, definition: SymbolDefinition) -> SymbolDefinition {
        let document: WorkspaceSource = self.find(path);
    ...
    func is_standard_source(path: String) -> Bool {
        if (path is null || self.wl_path is null) { return false; }
        let normalized: String = normalize_source_path(path);
        return normalized.starts_with(self.wl_path + "/std/");
    }

    func is_default_library(path: String, definition: SymbolDefinition) -> Bool {
    ...
    func type_name(path: String, line: Int, utf16_column: Int) -> String {
