...
class SourceMap {
    ...
    func position(line: Int, byte_column: Int) -> WhitelangExceptions.SourcePosition {
    ...
    func range(file: String, line: Int, byte_column: Int, byte_width: Int) -> WhitelangExceptions.SourceRange {
